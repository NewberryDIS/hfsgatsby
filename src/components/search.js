...
const Search = () => {
    ...
    const activateSearch = value => {
        ...
        const newloc = "/searchPage/?search=" + value
        navigate(newloc)
        // setQuery(value)
    } 
    const handleSubmit = () => {
    ...
    return (
        <SearchCss>
            ...
            />
            <SearchIcon activateSearch={activateSearch} value={value} />
        </SearchCss>
    )
}
